...
- Orchestrierung künftiger Agenten-Runden: `prompts/AGENTEN-PROMPT-LEITFADEN.md` — **nächste kopierbare Prompts** aus der **Rückmeldung an Projektleitung** des **Code Reviewers** allein (§0); Umsetzung der Vier-Prompt-Texte: `prompts/PL-NÄCHSTE-RUNDE-AUS-REVIEW.md`
