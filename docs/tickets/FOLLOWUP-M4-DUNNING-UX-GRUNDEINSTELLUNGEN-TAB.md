...
**Stand Agent-A (Wave3-14, 2026-04-27):** Abschnitt **Umsetzungs-Backlog** unten vollständig abgehakt (Hash-Alias, Schnellzugriff-Rollen, Copy/IA); Ticket bleibt **Backlog** bis PL für das **Zielbild** (dedizierter Tab ohne Duplikat-Logik).  
