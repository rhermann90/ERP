...
3. **Nächster Plan-Schritt laut Roadmap:** typisch **Slice 5b-2** (asynchroner Job statt nur synchronem POST) oder **PWA**; bis PL/UI explizit will, reicht **API-first**.

**Erinnerung:** Offen ist vor allem **Prozess (Merge)** und **nächstes Produktziel (5b-2 / UI)** — nicht zwingend noch eine Lücke in **5b-1** selbst, sobald Code-Review und CI grün sind.
