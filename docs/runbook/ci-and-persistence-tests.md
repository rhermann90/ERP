...
4. **Review:** mindestens ein fachlicher Review auf kritischen Pfaden (Mandantenisolation, Finanz-Traceability). **Entwicklungsphase:** Merge verlangt **keine** StB-/DSB-Freigabe — die Checkliste ist Vorbild für **späteres** Go-Live ([`Checklisten/compliance-rechnung-finanz.md`](../../Checklisten/compliance-rechnung-finanz.md)).
