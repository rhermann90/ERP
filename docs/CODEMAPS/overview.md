...
| **FIN-5 — §8.16 Steuerregime** | [`docs/adr/0015-fin5-invoice-tax-regimes-816.md`](../adr/0015-fin5-invoice-tax-regimes-816.md), `GET|PATCH /finance/invoice-tax-profile`, Projekt-Override `…/projects/{projectId}`, `src/services/invoice-tax-settings-service.ts`, `src/domain/invoice-calculation.ts` (`computeInvoiceTotalsForTaxRegime`) | Mandanten-Default + optional Projekt-Override; Rechnungs-Snapshot; Pflicht-Hinweiszeilen; Export XRechnung fail-closed bei Nicht-Standard; historisches Gate: [`FIN-5-GATE-816-FAIL-CLOSED.md`](../tickets/FIN-5-GATE-816-FAIL-CLOSED.md) |
