...
- **Erledigt 2026-04-27 (UTC, Doku):** PR [#47](https://github.com/rhermann90/ERP/pull/47) auf `main` gemergt (`cbacb7b`) — P1-3 **Stand** + Agent-Abnahme Merge #46, Tempo-Ergänzung nach #46 (Branch-Protection: kein direkter Push auf `main`); GitHub Actions [Run 25009980914](https://github.com/rhermann90/ERP/actions/runs/25009980914) grün (`backend`, `e2e-smoke`); **keine** neue P1-3-Meilenstein-Zeile (nur Doku).
