...
**Hinweis (2026-05-04):** FIN-5 Gate ist unter Option **B** geschlossen ([`FIN-5-GATE-816-FAIL-CLOSED.md`](../tickets/FIN-5-GATE-816-FAIL-CLOSED.md)); Implementierung von Steuerprofilen `/finance/invoice-tax-profile…` erfolgt in eigenem PR mit ADR-0014/0015 und OpenAPI-Bump — weiterhin **`npm run verify:pre-merge`** bei Finanz-/E2E-Touch empfohlen.
