...
- **Branch (Plan „Nächste Entwicklungsschritte“, 2026-04-27 UTC):** E2E Finanz-Smoke Tab **Fortgeschritten** zusätzlich **GET /audit-events** (Audit-Button); P1-3 **Stand** + Abnahmen, PL-WAVE3 **Wave3-13**; lokal `npm run verify:ci` und `npx playwright test e2e/login-finance-smoke.spec.ts` grün; **keine** neue P1-3-Meilenstein-Zeile.
