...
**Gewählte Spur (Team):** **B — FIN-5 §8.16 Option A (Folge-Inkremente)** seit Merge [#86](https://github.com/rhermann90/ERP/pull/86) (2026-05-04). Backlog der nächsten Pakete: [`FIN-5-FOLLOWUP-INCREMENTS.md`](../tickets/FIN-5-FOLLOWUP-INCREMENTS.md). Spur **A** (Option A / M4-Rest) pausiert; Skonto-PWA / Mahn-UX bleiben optional und können bei Bedarf in eigenen kleinen PRs nachgezogen werden. Vorherige Wahl Spur **A** (Repo-Default laut [`NEXT-INCREMENT-FINANCE-WAVE3.md`](../tickets/NEXT-INCREMENT-FINANCE-WAVE3.md)) gilt als abgeschlossen, sobald die Folge-Pakete unter Spur **B** beginnen.
