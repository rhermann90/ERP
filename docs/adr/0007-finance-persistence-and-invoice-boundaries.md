...
| **Mahnwesen (8.10)** | FIN-4 **Kern** (`dunning_reminders`, `dunning_tenant_stage_config`, Konfig-HTTP) — **ADR-0009**; **M4** Vorlagen/Footer/E-Mail inkl. SMTP — **ADR-0010**; Orchestrierung Slice **5b** — ADR-0010 (Proposed) + Koordinations-Ticket. | Mahngebühr laut Spez **nicht** still in 8.4(1–8) einmischen; eigene Buchungs-/Nebenforderungslinie (v1.3). |
