...
**Keine Rechtsberatung:** Konkrete B2B-/B2G-Pflichtprofile, KoSIT-Versionen und landesspezifische VATEX-Codes sollten **in der Organisation** (bei Bedarf mit Steuer-/Release-Verantwortung) mit dem Produkt-Scope (z. B. nur DE) abgestimmt werden — siehe [Checklisten/compliance-rechnung-finanz.md](../../Checklisten/compliance-rechnung-finanz.md) (E-Rechnung) und [`README.md`](../../README.md) (Compliance-Empfehlungen). Diese Matrix ist eine **implementierungsnahe Referenz** für das Repo-MVP, keine Zusage gegenüber Behörden oder Abnehmern.
