...
**Zweck:** Zentraler **Repo-Anker** für die Entscheidung „Batch-Mahn-E-Mail produktiv ja/nein“ und den Abgleich mit Compliance — **kein** KI-/Repo-Ersatz für organisatorische Nachweise außerhalb des Repos; Empfehlungen siehe [`README.md`](../../README.md), [`AGENTS.md`](../../AGENTS.md) Punkt 6; keine automatisierten Freigaben.

## Grenzen: Was Automatisierung **nicht** leistet

| Thema | Klärung |
|--------|---------|
| **Organisatorische Nachweise** | Freigaben, Protokolle und befüllte Checklistenpunkte sind **Team-/Mandantensache** (Begleitblatt-Kürzel wie Release, Steuer, Datenschutz sind Template-Namen). **Kein** KI-/CI-Lauf und **kein** Markdown-Eintrag im Repo ersetzt echte Nachweise; **keine** Repo-Pflichtfreigabe für Merge. |
...
Optional für das Team **vor** der Session: lokale Parität zu den GitHub-Jobs **`backend`** und **`e2e-smoke`** prüfen — Ergebnis im internen Protokoll festhalten, **nicht** als Mandanten-Produktiv-Go oder organisatorischen Nachweis missverstehen.
...
| Thema | Artefakt |
|--------|-----------|
| Massen-E-Mail 5c (fachlich + Betrieb) | [`Checklisten/compliance-rechnung-finanz.md`](../../Checklisten/compliance-rechnung-finanz.md) — **Teil C — C.5** (Massen-E-Mail; **empfohlen** relevante Begleitblatt-Zeilen im Team ausfüllen — Ledger-/Template-Kürzel z. B. „PL“, „StB“, „DSB“); ergänzend **Abschnitt 2** / FIN-4-Verweise und **Abschnitt 5** DSGVO wie dort verlinkt |
...
Protokolle, Freigaben und befüllte Checklistenpunkte: nur **manuell** im Team / mit dokumentierten organisatorischen Nachweisen — siehe **Team-Dokumentation** am Ende der [`Checklisten/compliance-rechnung-finanz.md`](../../Checklisten/compliance-rechnung-finanz.md). **Keine** Platzhalter-URLs im Repo als Ersatz für echte Nachweise ([`AGENTS.md`](../../AGENTS.md)).
