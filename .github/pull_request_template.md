...
**Compliance (optional):** Wenn der PR Rechnung/Steuer/Export/Aufbewahrung berührt und ihr die Begleitliste pflegen wollt — kurz verlinken oder „keine Doku-Änderung“. Merge **ersetzt keine** inhaltliche Bewertung der [`Checklisten/compliance-rechnung-finanz.md`](../Checklisten/compliance-rechnung-finanz.md); vor Produktivnutzung empfohlen: [`README.md`](../README.md) („Compliance … (Empfehlungen)“).
...
Enthält `npm run verify:ci` und anschließend Playwright für [`e2e/login-finance-smoke.spec.ts`](../e2e/login-finance-smoke.spec.ts), [`e2e/login-finance-smoke-fin5-tail.spec.ts`](../e2e/login-finance-smoke-fin5-tail.spec.ts) und [`e2e/app-shell-smoke.spec.ts`](../e2e/app-shell-smoke.spec.ts) (Ports **13000** / **15173** wie in [`playwright.config.ts`](../playwright.config.ts)).
