...
**Repo-Rahmen:** Ausfüllung und auf Ledger dokumentierte Klärungen sind **nicht** Voraussetzung für Feature- oder **Merge**-Arbeit. **Vor Mandanten-Produktivität** empfohlen: Inhalte nach bestem Wissen bearbeiten und — wenn ihr Hybrid-Ledger/Kürzel nutzt — Datum und Verantwortungslinie in der Zeile festhalten. Die Kürzel **PL / StB / DSB** sind **Benennungen im Template** (Release-/Steuer-/Datenschutz-Verantwortung in **eurer** Organisation); sie erzwingen **keine** automatische externe Pflichtsignatur durch eine Berufsbezeichnung.

**Zielbild:** Mandanten mit **SaaS- und digitalen Leistungsmodellen** (Abos, nutzungsbasierte Anteile, EU-/Drittlandsbezug). **Zweck:** Strukturierte Vorbereitung auf **Produktiv-Go**; **keine** Rechts- oder Steuerberatung. **Abhaken:** nur nach **fachlicher** Klärung in der Organisation (intern oder mit externen Berater:innen); Kürzel **„PL“** im Hybrid-Ledger = vereinbarter Release-/Owner-Anschriftspunkt im Paket, **nicht** gleich „Projektleitung“ der Softwareentwicklung.

**Abhaken-Konvention (Repo, Pflege durch Maintainer/Team):** Organisatorische, release- und repointerne Punkte, die **Maintainer:innen** allein tragen: ` — **YYYY-MM-DD · PL**`. **FIN-4 / Massen-E-Mail 5c** (Abschnitt 2): `[x]` vor produktivem Live-Versand **empfohlen** erst nach dokumentierter Klärung von SMTP, Footer, Stufen und Risiko in **eurem** Protokoll; wenn ihr Ledger-Kürzel verwendet, ein gemeinsames Datum z. B. ` — **YYYY-MM-DD · StB+DSB+PL**`. **Integrität:** Keine Kürzel oder Freigaben **erfunden** oder im Namen anderer eingetragen. **Leser-Hinweis:** Einzelne `[x]` **ersetzen** keine „alles erledigt“-Lesart für Mandanten-Go; Kontext in **derselben Zeile** und in den Notizen am Ende mitlesen. **Änderungsschutz:** Eine Zeile mit dokumentierter steuerlicher Zuständigkeit (`· StB`) wird nicht ohne **Rückabgleich mit der dort Genannten / dem Mandanten-Protokoll** überschrieben.

**Kontextannahmen (Team — steuerlich/DS-relevant fachlich klären):** Ausgangsunternehmen **GmbH in Deutschland**; Zielmärkte **Deutschland, Österreich, Schweiz**; **gemischtes** B2B/B2C **je Kunde unterschiedlich**; Kernprodukt **SaaS**; **Mischmodell** (Abo + nutzungsbezogene Anteile) für die **Nutzung der Software durch den ERP-Mandanten**; **leistungsbezogene Rechnungen**, die der Mandant **an seine Kunden** aus **LV/Aufmass/Angebot** erstellt, sind **eigenständige** Belegkette im ERP (nicht identisch mit der Plattform-Abrechnung). **Zahlungsabwicklung:** **Merchant-of-Record** (MoR) — fachliche Abgrenzung **Aussteller von Rechnungen / Zahlungsfluss / Buchungsnachweise** gegenüber ERP-Rechnungen mit **Release-Owner/StB** klären. **Technik:** **eigenes ERP**; Hosting **voraussichtlich EU**; **kein** produktiver Zugriff von **Support/Finance aus Drittländern** auf Rechnungs- und Zahlungsdaten ohne **dokumentierte organisatorische Freigabe** (z. B. Datenschutz-/Release-Linie nach internem Protokoll).
...
**CI ≠ Mandanten-Go / ≠ organisatorische Klärung:** Grüne GitHub-Actions-Jobs (**`backend`**, **`e2e-smoke`** am PR-Head) belegen nur **technische** Integrität ([`docs/contracts/qa-fin-0-gate-readiness.md`](../docs/contracts/qa-fin-0-gate-readiness.md) §5a). Sie **ersetzen keine** Abhakungen in dieser Checkliste und **keine** auf Ledger dokumentierte organisatorische Klärung — siehe [`docs/runbooks/m4-slice-5c-pl-mandanten-go.md`](../docs/runbooks/m4-slice-5c-pl-mandanten-go.md) (Abschnitt „Grenzen“).

**Evidenz pro Thema (Roll-out schrittweise, ohne Merge-Blocker):** Wo möglich, nach der jeweiligen Checkbox-Zeile oder in einer **Unterzeile** ergänzen — nicht alle Punkte auf einmal Pflicht:

| Baustein | Inhalt |
|----------|--------|
| **Regel / Risiko** | Bleibt in der bestehenden Listenzeile (Prüffrage). |
| **Systemverhalten (Ist)** | Kurz: Was tut die Software (Status, API-Oberfläche, Exportpfad); Verweis auf [`docs/ERP-Systembeschreibung.md`](../docs/ERP-Systembeschreibung.md) (§/Abschnitt), bei Bedarf [`docs/api-contract.yaml`](../docs/api-contract.yaml). |
| **Nachweis** | Verweis auf Testdatei, Gate-Dokument ([`docs/contracts/`](../docs/contracts/)), Runbook oder Golden-File — ein stabil erreichbarer Anker reicht. |
| **Organisatorisch** | Nur wenn nötig: „Nachweis extern“ (VVT, Vertrag, MoR) ohne Volltext im Repo. |
| **Bestätigung** | Unverändert: `[x]` + Datum + Rolle gemäß **Abhaken-Konvention** oben; **Anwalt** nur über internes Protokoll/Mustervertrag, keine Pflicht juristischer Volltexte hier. |

Überblicks-Spur Spez ↔ Nachweise (Pilotzeilen, erweiterbar): [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md).
...
- [x] **Verantwortlichkeiten:** Wer trägt Release-/Owner-Linie (PL), wer Steuer (StB), wer Datenschutz (DSB), wer IT-Sicherheit? **README** / **AGENTS.md** beschreiben **Empfehlungen** und Ledger-Kürzel — keine Pflicht, dass externes Personal mit diesen Kürzeln im Repo genannt wird; **personenbezogene Namen und IT-Sicherheit-Ansprechpartner** nur im **internen** Protokoll/Wiki. — **2026-04-29 · PL**
...
- [ ] **Pflichtangaben auf der Rechnung** (§ 14 UStG i. d. R.): vollständige Liste gegen Mustertext / StB geprüft; USt-IdNr., Ausstellungsdatum, fortlaufende Rechnungsnummer, Leistungszeitpunkt o. a. nach Vorgabe.
  ...
  **Systemverhalten (Ist):** Rechnungskopf und Positions-/Summenfelder werden serverseitig aus Stammdaten und LV-/Angebotskontext berechnet und über die Finanz-API bereitgestellt (Spez **8.2**, **8.4**, **5.5**).

  **Nachweis:** Matrix-Zeile „Pflichtangaben“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md); [`test/invoice-calculation.test.ts`](../test/invoice-calculation.test.ts); Rechnungs-Endpunkte in [`docs/api-contract.yaml`](../docs/api-contract.yaml).
- [ ] **Steuersätze / -arten:** Standard-USt reicht nicht für alle Mandanten — **§19 UStG**, **§13b**, **Reverse Charge**, **Bauleistungen** u. a. gemäß Spez **8.16** / Roadmap **FIN-5** modelliert und getestet (kein stiller Fallback auf 19 %).
  ...
  **Systemverhalten (Ist):** Steuerregime und Positionsklassifikation sind mandanten- und kontextabhängig modelliert (**8.16**); keine implizite Standardsteuer ohne fachliche Zuordnung laut Spez/FIN-5.

  **Nachweis:** [`docs/adr/0015-fin5-invoice-tax-regimes-816.md`](../docs/adr/0015-fin5-invoice-tax-regimes-816.md); [`docs/contracts/xrechnung-tax-regime-mapping.md`](../docs/contracts/xrechnung-tax-regime-mapping.md); Matrix-Zeile „Steuerregime“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md).
- [ ] **Brutto/Netto/Rundung:** Serverseitige **8.12**-Reihenfolge dokumentiert; Regressionstests für Randbeträge (Cent-Grenzen).

  **Systemverhalten (Ist):** Summenbildung und Rundungsreihenfolge werden in der Domänenschicht durchgesetzt (**8.12**), nicht durch das UI allein.

  **Nachweis:** [`test/invoice-calculation.test.ts`](../test/invoice-calculation.test.ts) (Randfälle); ADR-0007 / Spez **8.12**.
...
- [ ] **Korrekturbelege:** Storno/Gutschrift/Differenzbuchung (Spez **8.2** / **8.6**) fachlich und im UI/API nachvollziehbar; keine „stille“ Löschung gebuchter Daten.
  ...
  **Systemverhalten (Ist):** Korrektur und Differenzbuchung als eigene fachliche Vorgänge mit Versions-/Lebenszyklus zu gebuchten Belegen (**8.6**, Pilot **§16** Festlegung Aufmass).

  **Nachweis:** Matrix-Zeile „Korrekturbelege“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md); [`test/invoice-service-pilot-convergence.test.ts`](../test/invoice-service-pilot-convergence.test.ts).
...
- [ ] **Belegkette:** LV → Aufmass → Angebot → Rechnung → Zahlung → ggf. Mahnung; **Traceability** fail-closed wie in Gate/Tests vorgesehen.
  ...
  **Systemverhalten (Ist):** Verknüpfungen und Buchungs-/Freigabe-Checks erzwingen die Kette mandantenintern vor irreversiblen Schritten (Spez **4**, **8**, Abnahme **§15**).

  **Nachweis:** ADR-0007; [`test/persistence.integration.test.ts`](../test/persistence.integration.test.ts); [`docs/contracts/qa-fin-0-gate-readiness.md`](../docs/contracts/qa-fin-0-gate-readiness.md).
...
- [ ] **Unveränderbarkeit gebuchter Rechnungen:** Technisch und fachlich durchgesetzt (kein Edit nach „gebucht“ außer definierten Folgevorgängen).
  ...
  **Systemverhalten (Ist):** Nach Buchung/Freigabe gelten Mutationsverbote bzw. nur definierte Folgebelege (Spez **5.5**, **8.1**–**8.2**).

  **Nachweis:** Matrix-Zeile „Unveränderbarkeit“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md); Domänen-/API-Tests zu gebuchten Rechnungen; [`docs/contracts/ui-action-executor-coverage.md`](../docs/contracts/ui-action-executor-coverage.md).
...
- [ ] **Unveränderbarkeit / Nachvollziehbarkeit:** Audit-Events zu relevanten Mutationen; keine unbemerkten Änderungen an Buchungsgrundlagen.
  ...
  **Systemverhalten (Ist):** Zentrale Geschäftsschritte lösen serverseitige Audit-/Nachvollziehbarkeitsereignisse aus (Spez **12**, Finanz-Untermodell **8.x**).

  **Nachweis:** Matrix-Zeile „GoBD — Audit“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md); [`docs/contracts/fin6-logging-privacy-814.md`](../docs/contracts/fin6-logging-privacy-814.md).
...
- [ ] **Regression:** Golden-File-Tests oder Validator-Pipeline (offizielle Tools / Drittanbieter) in CI oder Release-Pipeline.
  ...
  **Systemverhalten (Ist):** Exportpfad und Profile sind über OpenAPI und Kontraktdokumente festgehalten (**14**); Validator-/Golden-File-Ausbau gemäß Produkt-Roadmap.

  **Nachweis:** [`docs/contracts/xrechnung-profile-scope-and-gaps.md`](../docs/contracts/xrechnung-profile-scope-and-gaps.md); Matrix-Zeile „E-Rechnung“ in [`docs/contracts/compliance-spec-traceability.md`](../docs/contracts/compliance-spec-traceability.md); wo vorhanden Export-/FIN-Tests in `test/`.
...
- [ ] **Zweckbindung & Minimierung:** Welche Felder in welchem UI/API-Layer (vgl. minimierte Audit-Lesepfade im Repo).
  ...
  **Systemverhalten (Ist):** API- und Log-Pfade reduzieren personenbezogene Daten in Audit-/Zahlungskontext (**8.14**, **13**); Zahlungsannahme protokolliert minimiert.

  **Nachweis:** [`docs/contracts/fin6-logging-privacy-814.md`](../docs/contracts/fin6-logging-privacy-814.md); [`test/privacy-log-redaction.test.ts`](../test/privacy-log-redaction.test.ts); [`test/finance-payment-intake-log-helpers.test.ts`](../test/finance-payment-intake-log-helpers.test.ts).
