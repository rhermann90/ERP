...
- **Produktiv-Go (UStG / HGB / AO / GoBD / E-Rechnung / DSGVO):** fachliche Abnahme-Checkliste ohne Code — [`Checklisten/compliance-rechnung-finanz.md`](./Checklisten/compliance-rechnung-finanz.md) (ersetzt **kein** separates Release-GO und **keine** StB-/Rechtsberatung).
