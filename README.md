...
- **Produktiv-Go (UStG / HGB / AO / GoBD / E-Rechnung / DSGVO):** Aktuell **Entwicklungsphase** — **keine** verpflichtenden menschlichen Fachfreigaben für Merge; Artefakte [`Checklisten/README.md`](./Checklisten/README.md) und [`Checklisten/compliance-rechnung-finanz.md`](./Checklisten/compliance-rechnung-finanz.md) werden nach bestem Wissen gepflegt; **formale** Abnahme und StB/DSB **vor** Mandanten-Go nachholen (ersetzt **kein** separates Release-GO und **keine** Beratung). **Kanonische Policy** (Single Source): [`AGENTS.md`](./AGENTS.md) Punkt 6.
